            ...
            <div className="bg-black/40 min-h-[400px]">
                <div className='container grid md:grid-cols-3 pb-20 pt-5'>
                    ...
                    <div className='py-8 px-4'>
                        ...
                        tracking-widest text-2xl sm:text-3xl font-cursive
                        '>Coffee Cafe</a>
                        <p className='pt-4'>
                            {" "}
                        ...
                        {/* <a href="https://www.youtube.com/@hamdoonur1507"></a> */}
                        <a href="https://www.youtube.come/channel/UC1H-a1MKEFXRiFlGNLcy7gQ" target='_blank'

                            className='inline-block bg-[#3d2517] py-2
                        px-4 mt-5 text-sm rounded-full'> Visit Our Youtube Channel
                    ...
                    '>
                        ...
                        <div className='py-8 px-4 col-span-2 sm:col-auto'>
                            <h1 className='text-xl font-semibold sm:text-left mb-3'>Address
